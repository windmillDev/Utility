...
public class SelectionSort extends SimpleSort{
	...
	/**
	 * SelectionSort
	 * Check every position of the array, if it's lower than the next position (left) or if it's higher as the last position (right). If it's true
	 * change the position of the current value with the lower/higher position.
	 * @param list	The unsorted list
